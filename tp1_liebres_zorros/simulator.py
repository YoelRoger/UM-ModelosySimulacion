...
class Simulator:
    def __init__(self, liebres=500, zorros=10, semanas=600, tasa_natalidad_liebres=0.08,
                 tasa_mortandad_liebres=0.002, tasa_mortandad_zorros=0.2, tasa_natalidad_zorros=0.0004, dt=1, tiempo_inicial=1):
    ...
    def calc_predator_variation(self):
        ...
        return ((self.tasa_natalidad_zorros * self.liebres * self.zorros) - (self.tasa_mortandad_zorros * self.zorros)) * self.dt
